...
use crate::{
    datatypes::{BoundlessError, MilestoneStatus, Project, ProjectStatus, FUNDING_PERIOD_LEDGERS, VOTING_PERIOD_LEDGERS}, BoundlessContract, BoundlessContractClient
};
...
fn test_release_milestone() {
    ...
    client.create_project(&project_id, &admin, &metadata_uri, &funding_target, &milestone_count);
