...
pub trait ProjectManagement {
    fn create_project( env: Env, project_id: String, creator: Address, metadata_uri: String, funding_target: u64, milestone_count: u32) -> Result<(), BoundlessError>;
...
pub trait VotingOperations {
    fn vote_project(env: Env, project_id: String, voter: Address, vote_value: i32) -> Result<(), BoundlessError>;
...
pub trait FundingOperations {
    fn fund_project(env: Env, project_id: String, amount: i128, funder: Address, token_contract: Address) -> Result<(), BoundlessError>;
    ...
    fn get_backer_contribution(env: Env, project_id: String, backer: Address) -> Result<u64, BoundlessError>;
}
